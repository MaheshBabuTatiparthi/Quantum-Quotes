...
@NgModule({
	...
	exports: [],
	entryComponents: [],
	providers: [{ provide: LOCALE_ID, useValue: "en-GB" },StatusBar,BannersService,CategoriesService,QuotesService,QuotesStorageService,ToastController,PopoverController,Globals]
})
